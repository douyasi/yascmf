...
@parent
					...
					<div class="breadcrumb_nav">
						<a href="{{ route('admin') }}"><i class="fa fa-home fa-fw"></i>Home</a>  &gt;  <a href="{{ route('admin.article.index') }}">内容管理</a>  &gt;  单页
						<!--筛选搜索-->
						<div class="search_box">
							<form action="{{ route('admin.page.index') }}" method="get">
								<input type="text" name="s_title" value="{{ Input::get('s_title') }}" placeholder="单页标题">
					...
					<div class="main_cmf_content">
						<form id="form_table" method="post" action="">
							<div class="cmf_cont">
								<p>
									<a href="{{ route('admin.page.create') }}"><i class="fa fa-fw fa-plus-circle" alt="新增" title="新增"></i>撰写新页面</a>
								</p>
									...
									<tbody>
										...
										<tr>
											<td class="text_center">
												<input type="checkbox" value="{{ $page->id }}" name="checkbox[]">
											</td>
											<td><a href="{{ route('admin.page.index') }}/{{ $page->id }}/edit"><i class="fa fa-fw fa-pencil" alt="修改" title="修改"></i></a>  <a href=""><i class="fa fa-fw fa-link" alt="预览" title="预览"></i></a>  <a href="javascript:void();"><i class="fa fa-fw fa-minus-circle delete_item" alt="删除" title="删除" data-id="{{ $page->id }}"></i></a></td>
											<td>{{ str_limit($page->title,25) }}</td>
...
@section('delete_item')
	...
	@include('scripts.endDeleteItem', ['_url' => route('admin.page.index')])
