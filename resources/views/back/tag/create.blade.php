...
@section('content')
    ...
    {!! Form::open( array('url' => route('admin.tag.store'), 'method' => 'post', 'id' => 'addArticleForm') ) !!}
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="tab_1">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tag_name" autocomplete="off" value="{{ Input::old('tag_name') }}" placeholder="标题">
                </div>
                <div class="form-group">
                    <label>缩略图
                    ...
                    <input type="text" class="form-control" id="thumb" name="tag_ico" value="{{ Input::old('tag_ico') }}" placeholder="缩略图地址：如{{ url('') }}/assets/img/yas_logo.png">
                </div>
            </div><!-- /.tab-pane -->
