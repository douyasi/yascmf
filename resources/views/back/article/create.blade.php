    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="tab_1">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" autocomplete="off"
                           value="{{ Input::old('title') }}" placeholder="标题">
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="thumb" name="thumb" value="{{ Input::old('thumb') }}"
                ...
                {{--                      <div class="form-group">
                <<<<<<< dd24d32c9707ecd17fd27e9192bbacf182778c83
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <select data-placeholder="选择文章标签..." class="chosen-select" style="min-width:200px;"
                                name="article_tag">
                            @foreach ($tags as $tag)
                                <option value="{{ $tag->id }}">{{ $tag->tag_name }}</option>
                            @endforeach
            ...
            <div class="tab-pane" id="tab_2">
                <div class="form-group">
                    <label>外链地址</label>
                    <input type="text" class="form-control" name="outer_link" value="{{ Input::old('outer_link') }}"
