...
@parent
					...
					<div class="breadcrumb_nav">
						<a href="{{ route('admin') }}"><i class="fa fa-home fa-fw"></i>Home</a>  &gt;  <a href="{{ route('admin.article.index') }}">内容管理</a>  &gt;  修改文章
					</div>
					<!--面包屑导航 end-->
					...
					<div class="main_form_content">
						<!--form start-->
								...
								<div class="tab_pane active">
									<ul>
										...
										<li>
											...
											<div class="form_item">
												<input type="text" id="thumb" name="thumb" value="{{ $data->thumb }}" placeholder="缩略图地址：如{{ url('') }}/assets/img/yas_logo.png">  <a href="javascript:void(0);" class="uploadPic"><i class="fa fa-fw fa-picture-o" title="上传"></i></a>  <a href="javascript:void(0);" class="previewPic"><i class="fa fa-fw fa-eye" title="预览小图"></i></a>
											</div>
										</li>
										<li>
											...
											<div class="form_item mono url_slug">
												@if(empty($data->slug))
												<p>{{ url('') }}/{category}/<input type="text" id="slug" name="slug" autocomplete="off" value="{{{ $data->id }}}" class="mono" maxlength="30" pattern="[A-z0-9_-]+">.html</p>
												@else
												<p>{{ url('') }}/{category}/<input type="text" id="slug" name="slug" autocomplete="off" value="{{{ $data->slug }}}" class="mono" maxlength="30" pattern="[A-z0-9_-]+">.html</p>
												@endif
											</div>
										</li>
										<li>
							...
							<div class="form_buttons">
								<input class="flat_btn yas_green" type="submit" name="submit" id="editArticleSubmit" value="修改文章">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
@stop
	...
	@include('scripts.endAjaxForm', ['_sub' => '#editArticleSubmit', '_form' => '#editArticleForm', '_loc' => route('admin.article.index')])
	@stop
