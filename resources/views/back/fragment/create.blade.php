...
@parent
					...
					<div class="breadcrumb_nav">
						<a href="{{ route('admin') }}"><i class="fa fa-home fa-fw"></i>Home</a>  &gt;  <a href="{{ route('admin.fragment.index') }}">内容管理</a>  &gt;  新增碎片
					</div>
					<!--面包屑导航 end-->
					...
					<div class="main_form_content">
						...
						{!! Form::open( array('url' => route('admin.fragment.store'), 'method' => 'post', 'id' => 'addFragmentForm') ) !!}
									...
									<ul>
										...
										<li>
											...
											<div class="form_item mono url_slug">
												<input type="text" id="slug" name="slug" autocomplete="off" value="" placeholder="slug碎片标识符" maxlength="20">
											</div>
										</li>
										<li>
							...
							<div class="form_buttons">
								<input class="flat_btn yas_green" type="submit" id="addFragmentSubmit" name="submit" value="新增碎片">
							</div>
							<!--form_control end-->
						{!! Form::close() !!}
						<!--form end-->
...
@stop
	...
	@section('ajaxForm')
		...
		@include('scripts.endAjaxForm', ['_sub' => '#addFragmentSubmit', '_form' => '#addFragmentForm', '_loc' => route('admin.fragment.index')])
