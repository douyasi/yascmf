	...
	<div class="category_edit_form">{{-- 表单数据项目 --}}
		<ul>
			<li>
				...
				<div class="form_item">
					<input type="text" id="name" name="name" autocomplete="off" value="" placeholder="分类名称" maxlength="20">
			...
			<li>
				...
				<div class="form_item">
					<input type="text" id="slug" name="slug" autocomplete="off" value="" placeholder="分类缩略名">
					<p class="tips_text" >分类缩略名用于创建友好的链接形式,建议使用字母,数字,下划线和横杠.</p>
				</div>
			</li>
			-->
			<li>
				...
				<div class="form_item">
					<textarea id="description" name="description" cols="45" rows="2" maxlength="200" placeholder="分类描述"></textarea>
		...
		<div class="form_buttons">
			<input class="flat_btn yas_green" type="submit" id="addCategorySubmit" value="增加分类">
		</div>
	</div>
{!! Form::close() !!}
@stop
